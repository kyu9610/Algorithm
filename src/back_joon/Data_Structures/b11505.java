...
public class b11505 {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i<M+K;i++){
            ...
            if(a==1){
                ...
                sb.append(findMul(1,N,1,b,c)).append('\n');
            }
        }
    ...
    public static int update(int start,int end,int node,int index,int val){
    ...
    public static int findMul(int start,int end,int node,int left,int right){
